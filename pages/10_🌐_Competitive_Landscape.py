...
def display_competition():
        ...
        st.markdown("The largest stablecoin, backed by traditional assets like cash and government bonds.")

        st.subheader("USD Coin (USDC):")
        st.markdown("Issued by a consortium of financial institutions, USDC is backed by a mix of assets including cash and U.S. Treasury bonds.")

        st.subheader("Binance USD (BUSD):")
        st.markdown("A stablecoin from Binance, backed by a basket of fiat currencies.")

        st.subheader("TerraUSD (UST):")
        st.markdown("An algorithmic stablecoin utilizing on-chain mechanisms and off-chain arbitrage to maintain its peg.")

        st.header("Lending Competitors:")

        st.subheader("Aave:")
        st.markdown("A decentralized lending protocol facilitating lending and borrowing of various crypto assets.")

        st.subheader("Compound:")
        st.markdown("Another popular lending protocol with a distinct token distribution model.")

        st.subheader("Uniswap:")
        st.markdown("A decentralized exchange (DEX) providing an alternative liquidity option for crypto assets.")

        st.subheader("dYdX:")
        st.markdown("A decentralized margin trading platform enabling users to leverage their crypto assets for trading.")
